...
```{r}
data <- simulate_multiple_targets_spline(5,31,seq(1,31,by = 3), num_df = 5, measurement_sigma_absolute = 0.1, measurement_sigma_relative = 0.2, regulator_measured = TRUE, integrate_ode45 = FALSE)
