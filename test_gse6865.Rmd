...
fit_source <- sampling(multiple_targets_model, data = data, control = list(adapt_delta = 0.95))
...
spline_samples <- t(samples_coeffs_mvn[samples_to_show,] %*% data$spline_basis ) * data$scale
ggmatplot(1:data$num_time, spline_samples, main_geom = main_geom)

#reprint regulator plot for compariosn
regulator_plot
...
print_plots <- TRUE
print_divergent_only <- FALSE
fits_known_reg <- list()
#for(t in 1:length(targets)) {
for(t in c(18,91,116,181,214,237,272,290,324,344,370,390,405,408,416,465,560,564,610,612,617,716,720,726,804)) {
#for(t in c(116,205,237,324,370,390,448,465,538,610,613,623,684)) {
#for(t in c(116,237,324,370,390,465)) {
  #set.seed(321487 + t * 31456445)
  set.seed(9245 + t * 4728)
