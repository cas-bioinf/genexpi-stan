...
for(target in targets) {
  ...
  print(ggmatplot(1:data$num_time, t(samples_expression), main_geom = main_geom) +
    geom_point(data = data.frame(x = data$measurement_times,  y = data$expression), aes(x=x, y=y), inherit.aes = FALSE, color = "blue", size = 3) + ggtitle(paste0("Expression - ", target)))
