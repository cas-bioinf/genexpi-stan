...
test_data_1 <- regulation_model_params(
  measurement_times = measurement_times,
  target_expression = t(expression_data[targets,]),
  regulator_expression = expression_data[source,],
  measurement_sigma = measurement_sigma_given(0.1,0.2),
...
test_data_2 <- regulation_model_params(
  measurement_times = measurement_times,
  target_expression = t(expression_data[targets,]),
  regulator_expression = expression_data[source,],
  measurement_sigma = measurement_sigma_given(0.1,0.2),
...
sampling_multi(multiple_targets_model, list(test_data_1, test_data_2), output.dir = "out", cores = 4, iter = 5)
```
